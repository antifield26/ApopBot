import { createBot as realCreateBot, loadMineflayerPluginsAsync as realLoadMineflayerPlugins } from './bot.ts'
import { classifyDisconnect, nextBackoff } from './reconnect.ts'
...
export class ConnectionManager {
   ...
   */
  constructor (cfg, logger, hooks: Record<string, any> = {}, deps: Record<string, any> = {}) {
    this.cfg = cfg
    this.log = logger
    this.hooks = hooks
    this._deps = {
  ...
  _wireEvents (seq) {
    ...
    this._spawnPromise = new Promise<void>((resolve) => {
