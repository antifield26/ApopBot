...
import { CROP_PLANT_MODE, SEED_BY_CROP } from '../crops.ts'
import { ACTION_COOLDOWN_MS, checkActionCooldown, raceAbort } from './common.ts'
import { ensureMiningTool } from '../tool.ts'
import { autoDeposit } from '../storage.ts'
