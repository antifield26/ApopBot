...
import { createActionExecutor } from '../core/executor.ts'
import { stopPathfinding } from '../core/movement.ts'
...
export class ScriptRunner {
  ...
  constructor (task, gen) {
    ...
    for (const [name, def] of Object.entries(task.scriptDef.ops ?? {}) as [string, any][]) {
